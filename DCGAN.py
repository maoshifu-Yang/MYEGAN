...
class generator(nn.Module):
    ...
    def __init__(self,input_dim = 100, output_dim = 1,input_size = 32):
        ...
        self.deconv = nn.Sequential(
            ...
            nn.BatchNorm2d(d),
            nn.ReLU(),
            nn.ConvTranspose2d(d,self.output_dim,4,2,1),
            nn.Tanh()
        )
...
class DCGAN(object):
    def __init__(self,args):
        ...
        data = self.data_loader.__iter__().__next__()[0]#迭代的数据
        print(data.shape[2],'the data shape is')
        # networks init
    ...
    def visualize_results(self, epoch, fix=True):
                ...
                samples = (samples + 1) / 2
                utilis.save_images(samples[:image_frame_dim * image_frame_dim, :, :, :],
    ...
    def save(self):
            ...
            with open(os.path.join(save_dir, self.model_name + "_history.pkl"), 'wb') as f:pickle.dump(self.train_hist, f)
